...
int rnum[6],bnum[6];
void output(int x){
    if(x>=0&&x<=9) cout<<"00"<<x<<' ';
    else if(x>=10&&x<=99) cout<<'0'<<x<<' ';
    else cout<<x<<' ';
}
void dragon_birth(int x,int y){
    if(x%3==0) cout<<"It has a sword,and it's morale is ";
    else if(x%3==1) cout<<"It has a bomb,and it's morale is ";
...
void ninja_birth(int x){
    if(x%3==0) cout<<"It has a sword and a bomb"<<endl;
    else if(x%3==1) cout<<"It has a bomb and a arrow"<<endl;
    else if(x%3==2) cout<<"It has a arrow and a sword"<<endl;
    return ;
}
void iceman_birth(int x){
    if(x%3==0) cout<<"It has a sword"<<endl;
    else if(x%3==1) cout<<"It has a bomb"<<endl;
    else if(x%3==2) cout<<"It has a arrow"<<endl;
    return ;
}
...
void bbirth(int j){
    if(bflag==0&&bm>=q[b[bcnt]].w){
        ...
        if(b[bcnt]==1) dragon_birth(j+1,bm);
        else if(b[bcnt]==2) ninja_birth(j+1);
        else if(b[bcnt]==3) iceman_birth(j+1);
        else if(b[bcnt]==4) lion_birth(bm);
        return ;
    }
...
int main(){
    ...
    for(int v=1;v<=t;v++){
        ...
        rflag=0,bflag=0;
        rcnt=0,bcnt=0;
        memset(rnum,0,sizeof(rnum));memset(bnum,0,sizeof(bnum));
